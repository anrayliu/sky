...
class Graphics:
    ...
    def draw(self, image: str, pos: Union[int, int], angle: Union[None, int, float] = None, size: Union[None, Tuple[int, int]] = None, transparency: Union[None, int] = None, radians: bool = False, center: Union[None, pygame.Rect] = None, use_cam: bool = True) -> pygame.Rect:
    ...
    def write(self, text: str, pos: Union[int, int], size: int = 30, colour: Union[pygame.Color, str] = "white", transparency: Union[None, int] = None, font: str = "arial", center: Union[None, pygame.Rect] = None, use_cam: bool = True) -> pygame.Rect:
        try:
